...
**Completed â Test planning, test design, functional execution, exploratory testing, defect reporting, and final reporting completed.**
...
- PIM â Employee List
- PIM â Add Employee
- PIM â Personal Details
- Admin â User Management
- My Info â Personal Details
...
- [Test Case Baseline â PDF](test-cases/orangehrm_test_cases_baseline_v1.0.pdf)
- [Test Case Baseline â CSV](test-cases/orangehrm_test_cases_baseline_v1.0.csv)

### Functional Test Results

- [Functional Test Run â PDF](test-results/orangehrm_functional_test_run_final_20260816.pdf)
- [Functional Test Run â CSV](test-results/orangehrm_functional_test_run_final_20260816.csv)

### Exploratory Testing

- [Exploratory Test Run â PDF](exploratory-testing/orangehrm_exploratory_test_run_final_20260816.pdf)
- [Exploratory Test Run â CSV](exploratory-testing/orangehrm_exploratory_test_run_final_20260816.csv)

### Defect Reports

- [Jira Defect Export â CSV](bug-reports/orangehrm_simulated_defects_20260816.csv)

### Test Summary

- [Test Summary Report â PDF](test-summary/orangehrm_test_summary_report_final_20260816.pdf)
...
The project demonstrates a complete manual QA workflow, including planning, test design, execution, exploratory testing, defect reporting, evidence collection, TestRailâJira traceability, and final reporting.
